    ...
    <h3>Meus Projetos</h3>
        ...
        if(count($projetos)>0){ 
            ...
            foreach($projetos as $projeto){
                echo '<li><a href="'.site_url('?controller=projeto&page=apagar&id='.$projeto->pr_id).'" class="request"><img src="'.base_url('static/img/Delete-48.png').'" width="24" height="24"/></a><a href="https://ilovedoc-pedlop.c9users.io/views/adicionarIntegrantes.html" rel="modal:open"><img src="'.base_url('static/img/addPessoa.png').'" width="24" height="24"/></a> ';
